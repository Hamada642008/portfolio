...
export default function Contact() {
    ...
    try {
        ...
        const res = await fetch("https://formsubmit.co/ajax/3189450329fd349fc5f52c1f0d36a25f ", {
            method: "POST",
            body: form
        });

        const result = await res.json();
        result.success ? setresponse("Thanks to contact me") : setresponse("Error!!");
    } catch {
        ...
        <section className='text-center my-20' id='contact'>
            ...
            <div className='w-11/12 my-10 mx-auto '>
                <form onSubmit={handlesubmit} method='post' className='background-card p-10 py-15 rounded-md flex flex-col  gap-5'>
                    ...
                    <input type="password" placeholder='Paasword' id='password' name='password' className='input' onChange={handlechange} value={formdata.password} required/>
